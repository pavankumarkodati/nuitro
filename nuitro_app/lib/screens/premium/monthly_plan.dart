...
class MonthlyPlan extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(bottomNavigationBar:
         CustomElevatedButton(text: 'Continue with \$4.99', onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Payment(selectedPlan: "Monthly Plan")),
              );
         }),
        ...
        body: SafeArea(
          child: Padding(padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
            ...
            child: Column(mainAxisAlignment:MainAxisAlignment.start,crossAxisAlignment:CrossAxisAlignment.start,children: [CustomBackButton2(label:'Monthly Plan' ,),
